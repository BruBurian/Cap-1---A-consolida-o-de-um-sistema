...
2. Preencher as variáveis abaixo:
...
3. Criar e confirmar a subscription no tópico SNS.
4. Usar a dashboard ou a CLI para disparar alertas.

## Evidências para entrega

- Print da dashboard completa.
- Print da Fase 2 mostrando as tabelas.
- Print da Fase 4 com a recomendação de irrigação.
- Print da Fase 6 com imagens processadas.
- Print do alerta recebido por e-mail ou SMS, se disponível.
...
- [x] Integração das fases em um único projeto.
- [x] Dashboard com os serviços das fases.
- [x] Comandos de terminal para execução.
- [x] Persistência centralizada em banco relacional.
- [x] Mensageria com AWS SNS e fallback local.
- [ ] Evidências visuais completas no README.
- [ ] Link do vídeo no YouTube.
- [ ] Confirmação de alerta real recebido.
